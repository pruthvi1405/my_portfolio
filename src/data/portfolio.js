...
// NOTE: a few bullets below are written without a specific number because
// you hadn't confirmed one yet (see the TODOs). Swap in a real metric where
// you have one — interview-ready bullets should hold up if someone asks
...
export const experience = [
  {
    ...
    points: [
      'Cut manual firmware-log analysis time 2–3 hours/day by integrating OpenAI GPT-based summarization into Python backend services, automatically surfacing key findings from validation logs so engineers could triage failures without reading raw output line-by-line.',
      ...
      'Cut triage latency 60% by building cloud-native backend services for log ingestion, telemetry processing, and platform health monitoring, replacing manual review with real-time visibility into 50,000+ daily validation events.',
      'Cut environment setup time 70% and standardized deployment across distributed validation teams by containerizing the platform’s internal services with Docker.',
      'Gave engineering teams real-time visibility into validation status and cross-environment health by building React and TypeScript telemetry dashboards, replacing ad hoc manual status checks.',
    ],
  },
  {
    ...
    points: [
      'Architected and built a beta-stage AI voice- and appointment-scheduling agent in Python using the OpenAI API, automating end-to-end client intake and cutting manual scheduling overhead 60% across 5+ beta clients.',
      ...
      'Designed and deployed cloud-hosted (AWS) backend services and Node.js orchestration pipelines connecting lead capture, qualification, scheduling, and follow-up, improving client response times 3x and eliminating manual handoffs during active beta testing.',
  ...
  },
  {
    ...
    points: [
      ...
      'Built core conversation-flow logic for an AI-powered appointment-scheduling agent using Python and the OpenAI API, enabling automated client intake ahead of the platform’s beta rollout.',
      'Developed and tested REST API integrations in Node.js connecting a voice-based virtual assistant to backend scheduling and CRM systems, improving data accuracy between call intake and booking records.',
      'Built internal React dashboards to visualize scheduling-agent call outcomes and system performance, giving the engineering team real-time insight into automation reliability during development.',
      'Deployed and validated service updates in an AWS cloud environment as part of the team’s CI/CD pipeline, supporting reliable releases during active beta development.',
    ],
  },
  {
    ...
    points: [
      ...
      'Improved codebase health across the PyEZ framework by resolving 150+ pylint violations, cutting the module’s lint warning count roughly 80% and reducing review friction for future contributors.',
